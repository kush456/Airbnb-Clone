...
export default function Perks({selected,onChange}) {//here because we want to export this as well, props hai ye 
    function handleCbClick(ev) {
      //a very efficient way using filter function to eliminate unchecked perk
